...
3. Run `docker pull seankross/bologna`
5. To start the RStudio server `docker run --name=rstudiocon -e USER=<username> -e PASSWORD=<password> -dp 8787:8787 seankross/bologna`.  You may also do `-e ROOT=TRUE`, but you still should have USER/PASSWORD.  
...
6. Copy YouTube credentials from DO to Docker: `docker cp YOUTUBE.json "rstudiocon":/home/${username}/YOUTUBE.json`
6. Permissions for user: `docker exec -it "rstudiocon" chown ${username} /home/${username}/YOUTUBE.json`
